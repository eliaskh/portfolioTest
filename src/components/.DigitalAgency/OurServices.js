      ...
      <div className="container">
        <div className="section-title st-fs-28">
          ...
          <p>
            ...
            מהרעיון והניסוח העיקרי של אסטרטגיית המוצר, עיצוב ובניית אב טיפוס,
            בדיקתו עם משתמשים ולסיום יצירת המוצר המוגמר
          </p>
        </div>
        ...
        <div className="row justify-content-center">
          <div className="col-lg-4 col-sm-6 col-md-6">
            <div className="agency-services-box">
              ...
              <div className="content">
                <h3>
                  <Link to="/service-details">בניית אתרים</Link>
                </h3>
          ...
          <div className="col-lg-4 col-sm-6 col-md-6">
            <div className="agency-services-box">
              ...
              <div className="content">
                <h3>
                  <Link to="/service-details">עיצוב חווית משתמש</Link>
                </h3>
          ...
          <div className="col-lg-4 col-sm-6 col-md-6">
            <div className="agency-services-box">
              ...
              <div className="content">
                <h3>
                  <Link to="/service-details">פיתוח אפליקציות מובייל</Link>
                </h3>
          ...
          <div className="col-lg-4 col-sm-6 col-md-6">
            <div className="agency-services-box">
              ...
              <div className="content">
                <h3>
                  <Link to="/service-details">חנויות אונליין</Link>
                </h3>
          ...
          <div className="col-lg-4 col-sm-6 col-md-6">
            <div className="agency-services-box">
              ...
              <div className="content">
                <h3>
                  <Link to="/service-details">עיצוב גרפי</Link>
                </h3>
          ...
          <div className="col-lg-4 col-sm-6 col-md-6">
            <div className="agency-services-box">
              ...
              <div className="content">
                <h3>
                  <Link to="/service-details">אנליזה וקידום אתרים</Link>
                </h3>
